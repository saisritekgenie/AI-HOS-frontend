...
export const AdminChatbot = ({ activeTab }) => {
  ...
  const [messages, setMessages] = useState([
    { 
      sender: "bot", 
      text: "Hello! I am your AI Operations Assistant. I can help you monitor staffing, evaluate department loads, check critical stock items, and analyze overall hospital occupancy. How can I assist you today?",
      takeaways: [],
      recommendations: ["Operations analytics are advisory. Confirm crucial inventories manually."]
    }
  ]);
  ...
  const handleSend = async (textToSend = inputVal) => {
    ...
    try {
      ...
      const botMsg = {
        sender: "bot",
        text: res.data.reply || "I have analyzed your operational query.",
      ...
      setMessages(prev => [...prev, { 
        sender: "bot", 
        text: "Sorry, I encountered an issue connecting to the hospital operations AI. Please verify authorization and try again.",
        takeaways: [],
        recommendations: []
      }]);
    } finally {
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
              <div style={{ width: "32px", height: "32px", borderRadius: "50%", background: "rgba(56, 189, 248, 0.2)", display: "flex", alignItems: "center", justifyItems: "center", justifyContent: "center" }}>
                <Bot size={18} style={{ color: "#38bdf8" }} />
              </div>
              <div>
                <h4 style={{ margin: 0, fontSize: "0.95rem", fontWeight: 800 }}>Operations AI Desk</h4>
                <span style={{ fontSize: "0.65rem", color: "#94a3b8", display: "flex", alignItems: "center", gap: "0.2rem" }}>
                  <span style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#10b981", display: "inline-block" }}></span>
                  Hospital Resource Specialist
                </span>
              </div>
            </div>
            <button
          ...
          <div style={{ flex: 1, padding: "1.25rem", overflowY: "auto", display: "flex", flexDirection: "column", gap: "1rem" }}>
              ...
              >
                <div
                  style={{
                    ...
                    background: m.sender === "user" ? "#0f172a" : "#f1f5f9",
            ...
            {loading && (
              <div style={{ display: "flex", alignSelf: "flex-start", gap: "0.5rem", alignItems: "center", background: "#f8fafc", padding: "0.5rem 0.75rem", borderRadius: "12px" }}>
                <span style={{ fontSize: "0.8rem", color: "#64748b", fontWeight: 600 }}>Analyzing operations...</span>
              </div>
            )}
          ...
          <div style={{ padding: "0.25rem 1rem", display: "flex", gap: "0.4rem", flexWrap: "wrap", borderTop: "1px solid #f1f5f9" }}>
            <button 
              onClick={() => handleSend("Evaluate current hospital occupancy rate.")} 
              style={{ border: "1px solid #e2e8f0", background: "none", borderRadius: "12px", padding: "0.25rem 0.5rem", fontSize: "0.65rem", cursor: "pointer", color: "#475569" }}
            >
              🏢 Occupancy check
            </button>
            <button 
              onClick={() => handleSend("Identify low-stock essential medicines.")} 
              style={{ border: "1px solid #e2e8f0", background: "none", borderRadius: "12px", padding: "0.25rem 0.5rem", fontSize: "0.65rem", cursor: "pointer", color: "#475569" }}
            >
          ...
          <div style={{ padding: "0.75rem 1rem", borderTop: "1px solid #f1f5f9", display: "flex", gap: "0.5rem", alignItems: "center" }}>
            ...
            <input
              ...
              placeholder="Query admin operations..."
              style={{
                flex: 1,
